...
from src.models import TotalManagementExpenseModel


class TestTotalManagementExpenseModel(unittest.TestCase):
    ...
    def test_structural_getters_and_outputs_initialize_correctly(self):
        ...
        model = TotalManagementExpenseModel()
        ...
        self.assertEqual(model.output_names, [variable_names.MANAGEMENT_EXPENSE])

        # Verify explicit required variable signature bounds
        self.assertEqual(
            model.required_variables,
            [variable_names.MONTHLY_MANAGEMENT_EXPENSE]
        )
    ...
    def test_input_variables_property_setter_happy_path(self):
        ...
        model = TotalManagementExpenseModel()
        fresh_inputs = {
            variable_names.MONTHLY_MANAGEMENT_EXPENSE: 3500.0,
    ...
    def test_check_variables_missing_required_logs_error_and_raises(self):
        ...
        incomplete_inputs = {
            ...
            # Missing required variable_names.MONTHLY_MANAGEMENT_EXPENSE!
        }
        model = TotalManagementExpenseModel(incomplete_inputs)
    ...
    def test_evaluate_success_with_all_parameters(self):
        ...
        inputs = {
            variable_names.MONTHLY_MANAGEMENT_EXPENSE: 4000.0,
        ...
        self.assertEqual(enriched_output[variable_names.MANAGEMENT_EXPENSE], 12000.0)
