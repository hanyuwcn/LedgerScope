...
class TestMonthlyExpenseModel(unittest.TestCase):
    ...
    def test_structural_getters_and_outputs_initialize_correctly(self):
        ...
        self.assertEqual(model.output_names, [variable_names.MONTHLY_MANAGEMENT_EXPENSE])
    ...
    def test_evaluate_success_with_all_parameters(self):
        ...
        self.assertEqual(enriched_output[variable_names.MONTHLY_MANAGEMENT_EXPENSE], 3750.0)
    ...
    def test_evaluate_success_with_omitted_values_fallback(self):
        ...
        self.assertEqual(enriched_output[variable_names.MONTHLY_MANAGEMENT_EXPENSE], 2000.0)
