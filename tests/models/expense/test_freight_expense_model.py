...
from src.models import FreightExpenseModel


class TestFreightExpenseModel(unittest.TestCase):
    ...
    def test_structural_getters_and_outputs_initialize_correctly(self):
        ...
        self.assertEqual(model.output_names, [variable_names.FREIGHT_EXPENSE])
    ...
    def test_evaluate_returns_zero_constant(self):
        ...
        self.assertEqual(enriched_output[variable_names.FREIGHT_EXPENSE], 0.0)
    ...
    def test_parameter_mutation_no_effect(self):
        ...
        self.assertEqual(result[variable_names.FREIGHT_EXPENSE], 0.0)
