...
MERCHANT_FREIGHT_RATE = "MerchantFreightRate"
UNIT_MERCHANT_FREIGHT_EXPENSE = "UnitMerchantFreightExpense"
UNIT_MERCHANT_FREIGHT_EXPENSE_IN_RMB = "UnitMerchantFreightExpense(RMB)"
