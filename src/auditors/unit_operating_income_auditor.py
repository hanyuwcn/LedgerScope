...
class UnitOperatingIncomeAuditor(Auditor):
    ...
    Audit Logic:
        - Ensures: OperatingIncome == (FOB - EXW - Marketing - Freight(0) - FixedOverhead)
    """
