...
def calculate_cost_of_goods_sold(variables: dict) -> dict:
    ...
    Returns:
        dict: A dictionary containing the computed COGS value mapped to
            ...
            Example: {"CostOfGoodSold": 15000.0}
    """
    purchasing_price = variables[vn.UNIT_EXW_PRICE]
    units_sold = variables[vn.UNITS_SOLD]

    calculated_cogs = purchasing_price * units_sold
...
class CostOfGoodsSoldModel(Model):
    ...
    Description:
        ...
        against baseline aggregate unit volume metrics. It calculates the necessary direct capital
        outlay required to fulfill total unit demand, allowing margin analysis engines downstream
    ...
    Calculation Equation:
        ...
        Where:
        - "UnitExWorksPrice" maps to vn.UNIT_EXW_PRICE
